...
$$
$$
\sigma_{\alpha} \sim \mathcal{IG}(1, 1)
$$
...
$$
$$
\sigma_{\beta} \sim \mathcal{IG}(1, 1)
$$
...
__These fixed effect predictors are not currently rescaled__.
...
which was 590k games, ranging from 30 - 127k games per 36 players.
Fitting this model takes many hours on a computing cluster.

This results in the following estimated parameters.


```{r 17-19-bullet-global-update, fig.path = "figures/"}
fit <- readRDS(here("results/", "lichess1700-1900_mar/", 
                    "all_rated_bullet_model.RDS"))

users <- readRDS(here("results/",
                      "lichess1700-1900_mar/",
                      "users_bullet.RDS"))


fit$summary(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))

mcmc_hist(fit$draws(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))) +
  labs(title = "Global Parameters 17-19 Bullet",
       subtitle = "mu_beta is Winner Effect, Gamma1 is colour,
       Gamma2 is ELO Difference, others SDs")
...
- The global estimate for $\mu_{\beta}$, the global winner effect, is 
around 0. Posterior SD is large here.



```{r winner-effects-17-19-bullet-update, fig.path = "figures/"}
#| fig-height: 9

random_effect_post <- fit$draws() %>% as_draws_df() %>% 
...
random_effect_post %>% 
  ...
  ggplot(aes(value)) +
  geom_histogram(fill = "#6497b1", colour = "black", linewidth = 0.2) +
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 6) +
  labs(title = "Winner Effects", y = "") +
...
-The largest posterior mean here is 0.4. This is saying that if on
average you win 50% of your games, but have instead won 10 in a row, your
probability of winning the next would increase by ~5% over that baseline.
However most estimated effects are small, and most of these posterior
distributions contain 0.


```{r indiv-effects-17-19-bullet-update, fig.path = "figures/"}
#| fig-height: 9
...
random_effect_post %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 6) +
  labs(title = "Individual Effects", y = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
```
...
With the same restrictions on the games this gives us 722k games.
We have between 150 and 88k games for each of these 39 players.


```{r global-effects-20-22-bullet-update, fig.path = "figures/"}

fit2 <- readRDS(here("results/", "lichess2000-2200_mar/", 
                    "all_rated_bullet_model.RDS"))
...
#        subtitle = "mu1 is Winner Effect, mu2 is Player Effect, Gamma1 is colour,
#        Gamma2 is ELO Difference")
mcmc_hist(fit2$draws(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))) +
  labs(title = "Global Parameters 20-22 Bullet",
       subtitle = "mu_beta is Winner Effect, Gamma1 is colour,
       Gamma2 is ELO Difference, others SDs")

users_20_22 <- readRDS(here("results/", 
                      "lichess2000-2200_mar/",
                      "users_bullet.RDS"))

fit2$summary(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]", "tau[2]",
                           "sigma_1", "sigma_g1", "sigma_g2"))

```



```{r winner-effects-20-22-bullet-update, fig.path = "figures/"}
#| fig-height: 9

players <- users_20_22
names(players) <- paste0("beta[", 1:length(users_20_22), "]")

random_effect_post2 <- fit2$draws() %>% as_draws_df() %>% 
  select(starts_with("beta[")) %>% 
  pivot_longer(cols = everything()) %>% 
  mutate(param = stringr::str_extract(name, pattern = "\\d"),
         id = stringr::str_extract(name, pattern = "\\d+]"),
...
```{r indiv-effects-20-22-bullet-update, fig.path = "figures/"}
#| fig-height: 9
...
We look at all players rated between 2300 and 2500. This gives us 599k games,
with 38 players playing 17-74k games. 

Size of the colour effect increases here when the ratings are larger,
as does the ELO difference effect.

```{r global-effects-23-25-bullet-update, fig.path = "figures/"}
fit3 <- readRDS(here("results/", "lichess2300-2500_mar/", 
                    "all_rated_bullet_model.RDS"))


users_23_25 <- readRDS(here("results/", 
                      "lichess2300-2500_mar/",
                      "users_bullet.RDS"))

mcmc_hist(fit3$draws(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))) +
  labs(title = "Global Parameters 23-25 Bullet",
       subtitle = "mu_beta is Winner Effect, Gamma1 is colour,
       Gamma2 is ELO Difference, others SDs")

fit3$summary(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))
```


```{r winner-effects-23-25-bullet-update, fig.path = "figures/"}
#| fig-height: 9
...
random_effect_post3 <- fit3$draws() %>% as_draws_df() %>% 
  select(starts_with("beta[")) %>% 
  pivot_longer(cols = everything()) %>% 
  mutate(param = stringr::str_extract(name, pattern = "\\d"),
         id = stringr::str_extract(name, pattern = "\\d+]"),
...
```{r indiv-effects-23-25-bullet-update, fig.path = "figures/"}
#| fig-height: 9
...
Note that now there are 109k games here, considerably fewer than 
the number of bullet games played. There are 8 players
who play less than 25 blitz games.

```{r global-effects-17-19-blitz, fig.path = "figures/"}

fit_blitz <- readRDS(here("results/", "lichess1700-1900_mar/", 
                    "all_rated_blitz_model.RDS"))

users_blitz <- readRDS(here("results/",
                      "lichess1700-1900_feb/",
                      "users_blitz.RDS"))

mcmc_hist(fit_blitz$draws(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))) +
...
fit_blitz$summary(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))
```
...
random_effect_post <- fit_blitz$draws() %>% as_draws_df() %>% 
  select(starts_with("beta[")) %>% 
  pivot_longer(cols = everything()) %>% 
  mutate(param = stringr::str_extract(name, pattern = "\\d"),
         id = stringr::str_extract(name, pattern = "\\d+]"),
...
players <- users_blitz
names(players) <- paste0("beta[", 1:length(users_blitz), "]")
...
random_effect_post %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 5) +
  labs(title = "Winner Effects, 1700-1900 Blitz", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
...
random_effect_post %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 5) +
  labs(title = "Indiv Effects, 1700-1900 Blitz", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
...
Here we have 190k games.

```{r global-effects-20-22-blitz, fig.path = "figures/"}
#| fig-height: 9

fit2_blitz <- readRDS(here("results/", "lichess2000-2200_feb/", 
                    "all_rated_blitz_model.RDS"))

users_blitz_2 <- readRDS(here("results/",
                      "lichess2000-2200_feb/",
                      "users_blitz.RDS"))

mcmc_hist(fit2_blitz$draws(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))) +
  labs(title = "Global Parameters 20-22 Blitz",
       subtitle = "mu_beta is Winner Effect, mu2 is Player Effect, Gamma1 is colour,
       Gamma2 is ELO Difference")


fit2_blitz$summary(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))
...
random_effect_post2 <- fit2_blitz$draws() %>% as_draws_df() %>% 
  select(starts_with("beta[")) %>% 
  pivot_longer(cols = everything()) %>% 
  mutate(param = stringr::str_extract(name, pattern = "\\d"),
         id = stringr::str_extract(name, pattern = "\\d+]"),
...
players <- users_blitz_2
names(players) <- paste0("beta[", 1:length(users_blitz_2), "]")
...
random_effect_post2 %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 5) +
  labs(title = "Winner Effects, 2000-2200 Blitz", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
...
random_effect_post2 %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 5) +
  labs(title = "Indiv Effects, 2000-2200 Blitz", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
...
Here we have only 62k total games.

```{r global-effects-23-25-blitz, fig.path = "figures/"}
#| fig-height: 9

fit3_blitz <- readRDS(here("results/", "lichess2300-2500_feb/", 
                    "all_rated_blitz_model.RDS"))

users_blitz_3 <- readRDS(here("results/",
                      "lichess2300-2500_feb/",
                      "users_blitz.RDS"))

mcmc_hist(fit3_blitz$draws(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))) +
...
fit3_blitz$summary(variables =  c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))
...
## winner effects
players <- users_blitz_3
names(players) <- paste0("beta[", 1:length(users_blitz_3), "]")

player_labels <- as_labeller(players)

random_effect_post3 <- fit3_blitz$draws() %>% as_draws_df() %>% 
  select(starts_with("beta[")) %>% 
  pivot_longer(cols = everything()) %>% 
  mutate(param = stringr::str_extract(name, pattern = "\\d"),
         id = stringr::str_extract(name, pattern = "\\d+]"),
...
random_effect_post3 %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 5) +
  labs(title = "Winner Effects, 2300-2500 Blitz", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
...
random_effect_post3 %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 5) +
  labs(title = "Indiv Effects, 2300-2500 Blitz", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
...
fit_prev <- readRDS(here("results/", "lichess1700-1900_mar/", 
                    "all_rated_bullet_model_prev.RDS"))

## these will be the same users

mcmc_hist(fit_prev$draws(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))) +
...
fit_prev$summary(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))
```



The effects when only looking at the previous game are 
much smaller than previous 10, mostly very close to 0 here.
...
random_effect_post4 <- fit_prev$draws() %>% as_draws_df() %>% 
  select(starts_with("beta[")) %>% 
  pivot_longer(cols = everything()) %>% 
  mutate(param = stringr::str_extract(name, pattern = "\\d"),
         id = stringr::str_extract(name, pattern = "\\d+]"),
...
random_effect_post4 %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 6) +
  labs(title = "Winner Effects, 1700-1900 Bullet, Previous Game", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
...
The individual effects seem to be quite small here also.
...
random_effect_post4 %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 6) +
  labs(title = "Indiv Effects, 1700-1900 Bullet Previous", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
...
fit2_prev <- readRDS(here("results/", "lichess2000-2200_mar/", 
                    "all_rated_bullet_model_prev.RDS"))

mcmc_hist(fit2_prev$draws(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))) +
...
fit2_prev$summary(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))
...
random_effect_post5 <- fit2_prev$draws() %>% as_draws_df() %>% 
  select(starts_with("beta[")) %>% 
  pivot_longer(cols = everything()) %>% 
  mutate(param = stringr::str_extract(name, pattern = "\\d"),
         id = stringr::str_extract(name, pattern = "\\d+]"),
...
random_effect_post5 %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 5) +
  labs(title = "Winner Effects, 2000-2200 Bullet, Previous Game", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
...
random_effect_post5 %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 5) +
  labs(title = "Indiv Effects, 2000-2200 Bullet, Previous Game", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
```
...
fit3_prev <- readRDS(here("results/", "lichess2300-2500_mar/", 
                    "all_rated_bullet_model_prev.RDS"))

mcmc_hist(fit3_prev$draws(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))) +
...
fit3_prev$summary(variables = c("mu_beta", "gamma1", "gamma2", "tau[1]",
                          "tau[2]", "sigma_1", "sigma_g1", "sigma_g2"))
...
random_effect_post6 <- fit3_prev$draws() %>% as_draws_df() %>% 
  select(starts_with("beta[")) %>% 
  pivot_longer(cols = everything()) %>% 
  mutate(param = stringr::str_extract(name, pattern = "\\d"),
         id = stringr::str_extract(name, pattern = "\\d+]"),
...
random_effect_post6 %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 5) +
  labs(title = "Winner Effects, 2300-2500 Bullet, Previous Game", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
...
random_effect_post6 %>% 
  ...
  facet_wrap(~player_id, scales = "free", labeller = player_labels, 
             ncol = 5) +
  labs(title = "Indiv Effects, 2300-2500 Bullet, Previous Game", y = "", x = "") +
  theme(axis.text.y = element_blank(),
        axis.ticks.y = element_blank())
...
small_data <- lichess_data %>%
  ...
  ## here multiple time formats will contribute, so going to include them
  ## for now
