...
When we consider more historic games the winner effects do appear to shrink,
as we saw in the bullet data. However, there seems to still be
very strong evidence for some effect. This model does not fit as 
well, but this can be fixed.
