...
```{r figure 3 - plot global parameters for 17-19}
...
```{r figure 3 - global parameters for gm data}
...
```{r figure 5 - compare global params n-1 vs n-10}
...
## TO DO - not a current paper plot, not updated
data_path <- here("results/lichess1700-1900")
